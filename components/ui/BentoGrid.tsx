...
export const BentoGridItem = ({
  ...
  const leftLists = ["Stretch", "Cajas", "Pluribol"];
  const rightLists = ["Cintas Especificas", "Cartón Corrugado", "Silica"];
  ...
  const handleCopy = () => {
    const text = "info.zcode@gmail.com";
        ...
        >
          {(id <= 3 || id === 5) && (
            <div className="relative z-20">
              <div className="absolute inset-0 bg-gray-800 bg-opacity-70 backdrop-blur-sm md:backdrop-blur-md rounded-lg"></div>
